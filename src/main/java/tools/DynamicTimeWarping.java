...
/**
 * Source: http://trac.research.cc.gatech.edu/GART/browser/GART/weka/edu/gatech/gart/ml/weka/DTW.java?rev=9
...
public class DynamicTimeWarping {
	...
	public DynamicTimeWarping(Double[] sample, Double[] templete) {
		seq1 = sample;
		seq2 = templete;
